...
class UICurrencyField extends React.Component {
    ...
    render() {
        ...
        onKeyPress = {
            this.onKeyPressHandle
        }
        alignType = {
            this.props.alignType
        }
        />
            </Col>
        )
...
UICurrencyField.defaultProps = {
    ClazzType: 'UICurrencyField',
    valueWithObject: {},
    visible: true,
    commonProps: {},
};

export default UICurrencyField;